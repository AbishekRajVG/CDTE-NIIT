...
//	
	...
	// prod.setBrand("Asus");
	// prod.setDescription(
	// "Base clock 1632 MHz Boost Clock (OC Mode) featuring 11GB GDDR5X 352-bit
	// memory, 3584 CUDA cores, and 11GB Frame Buffer");
	...
	// prod.setBrand("Intel");
	// prod.setDescription("Intel LGA1151 8th Gen Core i7-8700K Processor 6
	// Cores/12 Threads ");
	...
	// prod.setBrand("AMD");
	// prod.setDescription("AMD Ryzen Threadripper 1950X (16-core/32-thread)
	// Desktop Processor ");
	...
	// prod.setDescription("Samsung 850 EVO 500GB with R/W 540MB/s and 520MB/s
	// respectively ");
	...
	// prod.setDescription("Logitech G810 Orion Spectrum RGB Mechanical Gaming
	// Keyboard w/ Ultra-Responsive Romer-G Mechanical Key Switches ");
	// prod.setUnit_price(10000);
	// prod.setQuantity(15);
	// prod.setActive(true);
